...
Original file is located at
    https://colab.research.google.com/drive/1mCqkS0he8CKT4I0PXsIxtGD8FsNTOtS5
"""
...
# Reading Dataset:
dataset = pd.read_csv("/content/Kidney_data (1).csv")

# Dropping unneccsary feature :
#dataset = dataset.drop('Unnamed: 0', axis=1)

# The following code appears to be intended for a different dataset
# with columns like 'rbc', 'pc', 'pcc', 'ba', 'htn', 'dm', 'cad', 'appet', 'pe', 'ane', and 'classification'.
# The current dataframe loaded from "/content/kidneyData.csv" does not contain these columns.
